import { ArrowRight, Building2, Mic2, Briefcase } from 'lucide-react'

const paths = [
  { icon: Building2, title: 'For Brands',   desc: 'Launch performance campaigns and pay only for verified results',    cta: 'Start Campaign' },
  { icon: Mic2,      title: 'For Creators', desc: 'Connect your profiles and start earning from verified brands',       cta: 'Join Marketplace' },
  { icon: Briefcase, title: 'For Agencies', desc: 'Manage multiple clients with white-label control panel',             cta: 'Request Demo' },
]
